...
<?php 
	...
	function registrarAviso($materia, $docente, $id, $titulo, $subtitulo, $descripcion, $fecha) {
		...
		$query = "INSERT INTO avisos (CODAVISO, CODMAT, IDDOC, IDUSUARIO, TITULO, SUBTITULO, CONTENIDO, FECHA_HORA) VALUES (NULL, '$materia', '$docente', '$id', '$titulo', '$subtitulo', '$descripcion', now())";
